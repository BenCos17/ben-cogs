            ...
            try:
                async with session.get(url) as response:
                    ...
                    if to_currency not in rates:
                        await ctx.send(f'Failed to fetch currency data. Please try again later. Error: Invalid currency code(s) provided.')
                        return
            ...
            try:
                async with session.get(url) as response:
                    ...
                    if base_currency not in rates:
                        await ctx.send(f'Failed to fetch currency data. Please try again later. Error: Invalid base currency code provided.')
                        return
